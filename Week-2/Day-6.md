    ...
    <div class="container-fluid vh-100">
        ...
        <div class="row h-100">
          ...
          <div class="col-4 col-md-3 border bg-light text-white">
            <div class="inner-row-1 bg-info rounded-top"> 
                &nbsp;Channels
                <ul class ="list-group">
            ...
            <br>
            <div class="inner-row-2 bg-info rounded-top">
                &nbsp;Direct Messages
                <ul class ="list-group">
          ...
          <div class="col-8 col-md-9 border border-primary bg-dark text-white">
              Business Communication Platform

            <div class="input-group row align-items-end">
                <span class="input-group-text align-items-end">Chat</span>
